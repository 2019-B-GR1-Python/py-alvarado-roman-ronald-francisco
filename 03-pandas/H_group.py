# -*- coding: utf-8 -*-
"""
Created on Sat Jan  4 09:17:36 2020
...
path_guardado_bin =  './data/art-completo'
...
for columna_agrupada, df_completo in df_agrupado:
    print(type(columna_agrupada)) #String
    print(type(df_completo)) #dataframe


#seccion_df['units'].value_counts()
...
def llenar_valores_vacios(series, tipo):
    ...
    if(lista_valores.empty == True):
        ...
        if(tipo == 'promedio'):
            ...
            # Busca los nan y pone el valor del promedio
...
df_valores_llenos = transforma_df(seccion_df)
